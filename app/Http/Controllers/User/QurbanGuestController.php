...
public function laporan($tahun = null)
{
    ...
    // Dramatis
    $dramatis = [
        1 => ['title' => $report->dramatis1_title, 'quote' => $report->dramatis1_quote, 'stat' => $report->dramatis1_stat, 'image' => $report->dramatis1_image],
        2 => ['title' => $report->dramatis2_title, 'quote' => $report->dramatis2_quote, 'stat' => $report->dramatis2_stat, 'image' => $report->dramatis2_image],
        3 => ['title' => $report->dramatis3_title, 'quote' => $report->dramatis3_quote, 'stat' => $report->dramatis3_stat, 'image' => $report->dramatis3_image],
    ];
    ...
    $keuangan = [
        ...
        'total_penerimaan_peserta' => $report->total_penerimaan_peserta,
        'total_penerimaan_infaq' => $report->total_penerimaan_infaq,
        'total_penerimaan' => $report->total_penerimaan,
        'total_pengeluaran' => $report->total_pengeluaran,
        'sisa_dana' => $report->sisa_dana,
    ];
