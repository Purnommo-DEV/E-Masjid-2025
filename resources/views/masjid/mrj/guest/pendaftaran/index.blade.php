...
@push('head')
    ...
    <meta property="og:title" content="Pendaftaran Santunan Ramadhan 1447H – Masjid Raudhotul Jannah">
    <meta property="og:description" content="Form pendaftaran santunan anak yatim & dhuafa Ramadhan di Masjid Raudhotul Jannah.">
    ...
    <meta name="twitter:title" content="Pendaftaran Santunan Ramadhan 1447H – Masjid Raudhotul Jannah">
    <meta name="twitter:description" content="Form pendaftaran santunan anak yatim & dhuafa Ramadhan.">
            ...
            <div class="bg-white rounded-2xl border border-emerald-100/60 shadow-lg overflow-hidden">
                <div class="p-4 lg:p-8">
                    ...
                    <div class="relative overflow-hidden mb-12">
                        ...
                        <div class="relative max-w-9xl mx-auto px-4 sm:px-2 lg:px-4 py-10 text-center">
                            ...
                            <div class="flex items-center justify-center gap-3 sm:gap-4 mb-6">
                                <img src="{{ asset('assets/mrj/mrj-mtrj.png') }}"
                                     alt="Logo MRJ"
                    ...
                    <form id="form-pendaftaran" class="space-y-7">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-control">
                                ...
                                <label class="label pt-0">
                                    <span class="label-text-alt text-sm font-semibold hidden"
                                          id="umurFullDetail">
                                    </span>
                                </label>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-control">
                                <label class="label pb-1" for="rt">
                                    <span class="label-text font-semibold text-slate-800">RT <span class="font-normal text-slate-500">(opsional)</span></span>
                                </label>
                                <input type="text" name="rt" id="rt" maxlength="5" inputmode="numeric"
                                       class="w-full px-4 py-3.5 rounded-xl border-2 border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all duration-300 outline-none placeholder-slate-400 text-slate-900 bg-white"
                                       placeholder="Contoh: 006" />
                                <p class="mt-1 text-xs text-slate-500">Opsional. Isi RT tempat tinggal anak apabila diketahui. Angka nol di depan tetap disimpan.</p>
                            </div>
                            <div class="form-control">
                                <label class="label pb-1" for="rw">
                                    <span class="label-text font-semibold text-slate-800">RW <span class="font-normal text-slate-500">(opsional)</span></span>
                                </label>
                                <input type="text" name="rw" id="rw" maxlength="5" inputmode="numeric"
                                       class="w-full px-4 py-3.5 rounded-xl border-2 border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all duration-300 outline-none placeholder-slate-400 text-slate-900 bg-white"
                                       placeholder="Contoh: 007" />
                                <p class="mt-1 text-xs text-slate-500">Opsional. Isi RW tempat tinggal anak apabila diketahui. Angka nol di depan tetap disimpan.</p>
                            </div>
                        </div>

                        <div class="form-control">
                            <label class="label pb-1" for="nama_rt">
                                <span class="label-text font-semibold text-slate-800">Nama RT / Koordinator <span class="font-normal text-slate-500">(opsional)</span></span>
                            </label>
                            <input type="text" name="nama_rt" id="nama_rt" maxlength="150"
                                   class="w-full px-4 py-3.5 rounded-xl border-2 border-slate-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all duration-300 outline-none placeholder-slate-400 text-slate-900 bg-white"
                                   placeholder="Contoh: Pak Parno" />
                            <p class="mt-1 text-xs text-slate-500">Opsional. Isi nama atau koordinator RT apabila diketahui.</p>
                        </div>
...
$(document).ready(function () {
    ...
    const umurFullDetail = $('#umurFullDetail');
    ...
    function hitungUmurDetail() {
        ...
        if (!value) {
            umurInput.val('');
            umurDetailBadge.addClass('hidden');
            umurFullDetail.addClass('hidden');
            return;
        }
        ...
        // ===============================
        // Badge tetap hanya satuan
        // ===============================
        let badgeText = '';
        if (years >= 1) badgeText = 'Tahun';
        else if (months >= 1) badgeText = 'Bulan';
        else badgeText = 'Hari';
        ...
        // Detail lengkap
        // ===============================
        let fullText = `${years} Tahun ${months} Bulan ${days} Hari`;

        umurFullDetail
            .removeClass('hidden text-red-600 text-emerald-600')
            .text(fullText);

        // ===============================
        // VALIDASI MAKSIMAL 13 TAHUN 11 BULAN XXX HARI
        // ==============================
        const isValid = years <= 13;
        ...
        if (!isValid) {
            ...
            umurHelper
                ...
                .text(`Usia melebihi batas maksimal (13 Tahun 11 Bulan)`);
