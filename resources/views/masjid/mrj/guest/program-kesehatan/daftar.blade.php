            ...
            <div class="bg-white rounded-3xl border border-emerald-100 shadow-xl overflow-hidden">
                ...
                <div class="h-px bg-emerald-100"></div>
                    ...
                    <div class="mt-8 pt-8 border-t border-emerald-100">
                        <div class="relative overflow-hidden rounded-2xl border border-emerald-200
                                    bg-gradient-to-br from-emerald-50 via-white to-teal-50
                                    p-5 sm:p-6 shadow-sm">

                            <!-- Dekorasi hanya tampil di layar besar -->
                            <div class="hidden md:block absolute -top-10 -right-10
                                        w-28 h-28 rounded-full bg-emerald-100 opacity-60">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="flex flex-col md:flex-row md:items-start gap-4 md:gap-5">
                                    ...
                                    <!-- Ikon -->
                                    <div class="shrink-0 w-12 h-12 rounded-xl bg-emerald-600
                                    ...
                                    <!-- Konten -->
                                    <div class="w-full min-w-0 text-center md:text-left">

                                        <h3 class="font-bold text-emerald-900 text-lg">
                                            Mengalami Kendala?
                                        </h3>
                                        ...
                                        <!-- Informasi admin -->
                                        <div class="mt-5 w-full rounded-xl bg-white
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                                            ...
                                            <a
                                                ...
                                                class="w-full min-h-[48px] inline-flex items-center
