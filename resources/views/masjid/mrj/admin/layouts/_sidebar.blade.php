            ...
            <ul class="space-y-2">
                ...
                <li class="mt-2">
                    ...
                    @php
                        ...
                        $financialV2Menu = [
                            ...
                            ['route' => 'financial-v2.bank-mutations.index', 'label' => 'Mutasi Bank'],
                            ['route' => 'financial-v2.funds.index', 'label' => 'Dana'],
                            ['route' => 'financial-v2.allocations.create', 'label' => 'Alokasi Dana'],
                            ['route' => 'financial-v2.transactions.drafts', 'label' => 'Draft Transaksi'],
                            ['route' => 'financial-v2.realizations.drafts', 'label' => 'Draft Realisasi'],
                ...
                <li class="mt-2">
                    ...
                    <ul x-show="openQurban" x-collapse class="mt-2 space-y-1 pl-6 overflow-hidden">
                        ...
                        <!-- Laporan Qurban -->
                        <li>
                            <a href="{{ route('admin.qurban.report.index') }}"
                            @class([
                                'flex items-center gap-3 px-4 py-2.5 rounded-lg transition text-xs md:text-sm',
                                'bg-amber-300/90 text-emerald-900 font-semibold shadow' => request()->routeIs('admin.qurban.report*'),
                                'text-white hover:bg-white/10' => !request()->routeIs('admin.qurban.report*')
                            ])>
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                                </svg>
                                <span>Laporan Qurban</span>
                            </a>
                        </li>
                        <!-- Evaluasi Qurban -->
                        <li>
                            <a href="{{ route('admin.evaluasi-qurban.index') }}"
                            @class([
                                'flex items-center gap-3 px-4 py-2.5 rounded-lg transition text-xs md:text-sm',
                                'bg-amber-300/90 text-emerald-900 font-semibold shadow' => request()->routeIs('admin.evaluasi-qurban*'),
                                'text-white hover:bg-white/10' => !request()->routeIs('admin.evaluasi-qurban*')
                            ])>
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m-3-3V8" />
                                </svg>
                                <span>Evaluasi Qurban</span>
                            </a>
                        </li>

                        <!-- Statistik Evaluasi -->
                        <li>
                            <a href="{{ route('admin.evaluasi-qurban.statistik') }}"
                            @class([
                                'flex items-center gap-3 px-4 py-2.5 rounded-lg transition text-xs md:text-sm',
                                'bg-amber-300/90 text-emerald-900 font-semibold shadow' => request()->routeIs('admin.evaluasi-qurban.statistik'),
                                'text-white hover:bg-white/10' => !request()->routeIs('admin.evaluasi-qurban.statistik')
                            ])>
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                                <span>Statistik Evaluasi</span>
                            </a>
                        </li>
                    </ul>
                </li>
